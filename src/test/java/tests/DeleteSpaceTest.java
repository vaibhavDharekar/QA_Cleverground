...
public class DeleteSpaceTest extends BaseTest{
	...
	WebDriver driver;
	DeleteSpace SpaceManagementpage;
	TestUtils utils;
    ...
    public void setup() {
        ...
        SpaceManagementpage = new DeleteSpace(driver); // Initialize Awards page here to avoid reinitializing in each test
...
//	}
	...
	public void DeleteSpace() throws InterruptedException {
	    Thread.sleep(5000);
	    SpaceManagementpage.DeleteSpaceBtn();
	    Thread.sleep(2000);
	}
	...
	public void DeleteSpaceOkbtn() throws InterruptedException {
	    Thread.sleep(2000);
	    SpaceManagementpage.BtnOk();
	    Thread.sleep(1000);
	}	
	
	@Test(priority = 64)
	public void DeleteSpaceOkbtn2() throws InterruptedException {
	    Thread.sleep(2000);
	    SpaceManagementpage.Okbtn();
	    Thread.sleep(1000);
	}	
