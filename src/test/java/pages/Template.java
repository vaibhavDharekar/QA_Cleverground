...
//    
    ...
    public void print() {
        ...
        actions.doubleClick(print).perform(); // Perform double-click

    
        print(); // This will use the JavaScript click for the 'print' element
    }

    // Method to click on the 'print' element using JavascriptExecutor
//    public void print() {
 //       WebElement print = driver.findElement(By.id("printButton")); // Change the locator as needed
  //      JavascriptExecutor js = (JavascriptExecutor) driver;
 //       js.executeScript("arguments[0].click();", print);  // Click the print element using JS
    }
